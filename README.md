...
完全固定でないと使えないわけではありません。ただし、タップした周辺の見た目を追うため、ガイドやロッドの輪郭が暗い、反射している、ピンぼけしている、背景と同化している場合は追従しにくくなります。

まずはスマホをなるべく固定し、元側・中間・穂先側の3点を、ガイドの輪郭や目印がはっきり入る位置でタップしてください。OpenCV.jsが読み込めない場合でも、アプリは簡易追跡モードで動きます。
